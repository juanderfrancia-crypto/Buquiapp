import { View, Text, TouchableOpacity, StyleSheet, Alert, ScrollView, StatusBar, ActivityIndicator, Modal, Linking } from 'react-native';
...
export default function ProfileScreen() {
  ...
  const getNextBookingText = () => {
    ...
    return new Date(stats.nextBooking.booking_date).toLocaleDateString('es-CO', {
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.roleBadge}>
            <Ionicons name={user?.role === 'barber' ? 'cut-outline' : 'person-outline'} size={13} color={Colors.accent} />
            <Text style={styles.roleText}>{user?.role === 'barber' ? 'Barbero' : 'Cliente'}</Text>
          </View>
        </View>
        ...
        <Text style={styles.version}>Barberly v1.0.0 · Hecho con ❤️</Text>
      </ScrollView>
      ...
      <Modal visible={notifVisible} animationType="slide" presentationStyle="pageSheet">
        <SafeAreaView style={styles.modal}>
          ...
          <ScrollView contentContainerStyle={styles.modalBody}>
            ...
            {[
              { icon: 'checkmark-circle-outline', text: 'Confirmación de tu reserva por el barbero' },
          ...
          <ScrollView contentContainerStyle={styles.modalBody} showsVerticalScrollIndicator={false}>
            ...
            {[
              ...
              },
              {
                icon: 'people-outline',
                title: 'Compartición',
                body: 'Solo compartimos tu nombre y contacto con el barbero de tu cita. Jamás vendemos tus datos.',
              },
              {
          ...
          <ScrollView contentContainerStyle={styles.modalBody} showsVerticalScrollIndicator={false}>
            ...
            {[
              ...
              },
              {
                ...
                a: 'Tu cita queda en estado "pendiente" hasta que el barbero la confirme. Te notificaremos en cuanto lo haga.',
              },
              {
              ...
              {
                q: '¿Qué pasa si el barbero cancela?',
        ...
        <SafeAreaView style={styles.modal}>
          ...
          <ScrollView contentContainerStyle={[styles.modalBody, styles.aboutBody]} showsVerticalScrollIndicator={false}>
            <View style={styles.aboutLogo}>
              <Ionicons name="cut" size={44} color={Colors.white} />
            </View>
...
const styles = StyleSheet.create({
  ...
  avatar: {
    ...
    marginBottom: 14, borderWidth: 3, borderColor: 'rgba(255,255,255,0.15)',
  },
